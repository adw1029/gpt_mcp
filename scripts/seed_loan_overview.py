...
FAKE_LOANS = [
    {
        ...
        "base_loan_amount": Decimal("320000"),
        "buyer_names": "Alex T Rivera",
        "buyer_vesting": "Joint Tenancy",
        "seller_names": "Desert Sun Realty LLC",
        "property_type": "Detached",
        "property_address": "55 Cactus Rd, Scottsdale, AZ 85251",
        "property_county": "Maricopa",
        "parcel_number": "173-44-012-B",
        "borrower_last_name": "Rivera",
        "loan_status": "In Progress",
        "loan_officer": "Jane Smith",
        "market_median_price": Decimal("415000"),
        "rate_environment": "6.75% 30yr fixed",
        "comparable_approvals_qtd": Decimal("1243"),
        "days_in_pipeline": Decimal("14"),
        "next_action_due": "Title document upload required",
        "risk_flags": ["First-time buyer", "HOA community"],
    },
    {
        "loan_id": "265561631",
        ...
        "loan_status": "In Progress",
        "loan_officer": "Jane Smith",
        "market_median_price": Decimal("387000"),
        "rate_environment": "6.80% 30yr fixed",
        "comparable_approvals_qtd": Decimal("847"),
        "days_in_pipeline": Decimal("21"),
        "next_action_due": "Insurance document upload required",
        "risk_flags": [],
    },
    {
        "loan_id": "319847205",
        ...
        "market_median_price": Decimal("498000"),
        "rate_environment": "6.65% 30yr fixed",
        "comparable_approvals_qtd": Decimal("2104"),
        "days_in_pipeline": Decimal("38"),
        "next_action_due": "Closing disclosure review",
        "risk_flags": ["Self-employed income", "Attached property type"],
    },
    {
        "loan_id": "408823917",
        ...
        "market_median_price": Decimal("875000"),
        "rate_environment": "6.90% 30yr fixed",
        "comparable_approvals_qtd": Decimal("412"),
        "days_in_pipeline": Decimal("7"),
        "next_action_due": "Appraisal ordered — awaiting report",
        "risk_flags": ["Jumbo loan threshold", "New construction"],
    },
]
